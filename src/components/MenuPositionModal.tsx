        ...
        <Modal>
          ...
          >
            ...
            >
              ...
              <main
                ref={containerRef}
                className='flex h-full flex-col justify-between overflow-y-auto bg-white pb-24'
              >
                <div className='z-10'>
                ...
                <footer className='fixed bottom-0 flex h-min w-full justify-center bg-white/60 px-4 py-3 backdrop-blur'>
                  {renderFooterContent(() => {
                    setInState(false);
                  })}
                </footer>
